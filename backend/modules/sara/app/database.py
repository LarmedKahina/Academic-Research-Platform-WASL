...
def normalize_supabase_database_url(
    ...
    """
    Supabase *transaction pooler* (port 6543, host ...pooler.supabase.com) expects username
    postgres.<project-ref>, not plain postgres. Wrong user → FATAL: Tenant or user not found.
    """
