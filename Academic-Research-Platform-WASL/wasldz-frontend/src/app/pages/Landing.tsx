            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/signup?role=professor">
                  <Button size="lg" variant="outline" className="h-14 px-8 text-lg border-2 border-[#1e293b] text-[#1e293b] hover:bg-[#1e293b] hover:text-white">
                    Professor sign up
                  </Button>
                </Link>
                <Link to="/signup?role=company">
                  <Button size="lg" variant="outline" className="h-14 px-8 text-lg border-2 border-[#0f766e] text-[#0f766e] hover:bg-[#0f766e] hover:text-white">
                    Company sign up
                  </Button>
                </Link>
              </div>
            ...
            >
              <Card className="bg-white/5 border-white/10 backdrop-blur h-full hover:bg-white/10 transition-all hover:scale-105 duration-300">
                <CardContent className="p-8">
                  ...
                  <Link to="/signup?role=student" className="text-[#f97316] hover:underline inline-flex items-center gap-2 group">
                    Register as student
            ...
            >
              <Card className="bg-white/5 border-white/10 backdrop-blur h-full hover:bg-white/10 transition-all hover:scale-105 duration-300">
                <CardContent className="p-8">
                  ...
                  <Link to="/signup?role=professor" className="text-white/90 hover:text-white hover:underline inline-flex items-center gap-2 group">
            ...
            >
              <Card className="bg-white/5 border-white/10 backdrop-blur h-full hover:bg-white/10 transition-all hover:scale-105 duration-300">
                <CardContent className="p-8">
                  ...
                  <Link to="/signup?role=company" className="text-white/90 hover:text-white hover:underline inline-flex items-center gap-2 group">
                    Register as company
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </CardContent>
