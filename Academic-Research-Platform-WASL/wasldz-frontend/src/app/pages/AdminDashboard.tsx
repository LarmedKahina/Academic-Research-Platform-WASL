            ...
            <Tabs defaultValue="pending_users">
              ...
              <TabsContent value="pending_projects" className="space-y-4">
                ...
                {pendingProjects.map((p) => (
                  <Card key={p.id} className="border-l-4 border-l-amber-500 shadow-sm overflow-hidden">
                    <CardContent className="pt-6 flex flex-wrap justify-between gap-4">
                      <div className="space-y-1 min-w-0">
                        <Link to={`/projects/${p.id}`} className="font-semibold text-lg text-[#1e3a8a] hover:underline">
                          {p.title}
                        </Link>
                        <p className="text-sm text-muted-foreground">
                      ...
                      <div className="flex flex-wrap gap-2 items-center">
                        <Button variant="outline" size="sm" type="button" asChild>
                          <Link to={`/projects/${p.id}`}>Detail page</Link>
                        </Button>
                        {p.file_url && (
                          <Button
                            variant="outline"
